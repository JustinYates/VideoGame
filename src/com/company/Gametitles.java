...
public class Gametitles {
    ...
    private String Call_Of_Duty_BoII;

    private String MineCraft;

    private String BattleField;

    private String DragonBallZfighters;

    private String MortalKombat;

    private String Injustice_2;
    ...
    public void setCall_Of_Duty_BoII(String call_Of_Duty_BoII) {
        Call_Of_Duty_BoII = call_Of_Duty_BoII;
    }
    ...
    public void setDragonBallZfighters(String dragonBallZfighters) {
        DragonBallZfighters = dragonBallZfighters;
    }
